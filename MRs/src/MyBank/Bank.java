...
// Beskrivning: (Innehåller en lista med alla inlagda kunder. Klassen ska innehålla ett
...
//public class BankLogic extends Account{
public class Bank {
...
//accountId som tillhör kunden pNr (kontonummer, saldo, kontotyp, räntesats)
